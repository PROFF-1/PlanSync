...
interface PreMountableActivityDetailsProps {
  activity: ItineraryActivity;
  visible: boolean;
  onClose: () => void;
}

const PreMountableActivityDetails: React.FC<PreMountableActivityDetailsProps> = ({
  activity,
  visible,
  onClose,
}) => {
  ...
  const mockPhotos = [
    `https://picsum.photos/400/300?random=${activity.id}1`,
    `https://picsum.photos/400/300?random=${activity.id}2`,
    `https://picsum.photos/400/300?random=${activity.id}3`,
    `https://picsum.photos/400/300?random=${activity.id}4`,
    `https://picsum.photos/400/300?random=${activity.id}5`,
  ];
...
export default PreMountableActivityDetails;
